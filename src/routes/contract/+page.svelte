...
<div class="m-auto w-[1200px] flex flex-col gap-2 items-center">
    ...
    <div class="w-full p-2 flex justify-between bg-[var(--color-header)]">
        <div><img src="" alt=""><p>Ваш баланс: <b>{60} ₽</b></p><img src="" alt=""></div>
        <h2 class="uppercase">ПОЛОЖИТЕ ЕЩЕ МИНИМУМ {3} ПРЕДМЕТА</h2>
